            ...
            <div class="container">
                ...
                <div class="col-md-10 column" id="content">
                    ...
                    <table id="table" class="table table-bordered table-hover">
                        ...
                        <c:forEach items="${pageEmployee.list}" var="emp">
                            <tr>
                                <td>${emp.eid}</td>
                                <td>${emp.ename}</td>
                                <td>${emp.sex}</td>
...
<%--                                </td>--%>
                                <td>
                                    <a href='#' class='delete btn btn-danger' onclick="confirmDel(${emp.eid})">删除</a>
                    ...
                    <ul class="pagination">
                        <li><a href="/employee/list2?pageNum=1"> 首页</a></li>
                        <li><a href="/employee/list2?pageNum=${pageEmployee.prePage}"> 上一页</a></li>
                        <c:forEach items="${pageEmployee.navigatepageNums}" var="p">
                            <li><a href="/employee/list2?pageNum=${p}"> ${p}</a></li>
                        </c:forEach>
                        <li><a href="/employee/list2?pageNum=${pageEmployee.nextPage}"> 下一页</a></li>
                        <li><a href="/employee/list2?pageNum=${pageEmployee.pages}"> 尾页</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="eid" class="col-sm-2 control-label">编号</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label for="section" class="col-sm-2 control-label">性别</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="sex" name="sex" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="section" class="col-sm-2 control-label">部门</label>
                        <div class="col-sm-10">
...
<script>
    function confirmDel(param){
        ...
        if(window.confirm("您确定要删除吗？")){
            document.location.href="/employee/delete?eid="+param
        }
    }
    ...
    function editRole(obj) {
        ...
        //获取表格中的一行数据
        var eid=document.getElementById("table").rows[id].cells[0].innerText;
        var ename = document.getElementById("table").rows[id].cells[1].innerText;
        var sex=document.getElementById("table").rows[id].cells[2].innerText;
        var section=document.getElementById("table").rows[id].cells[3].innerText;
        var post=document.getElementById("table").rows[id].cells[4].innerText;
        //向模态框中传值
        $('#eid').val(eid);
        //禁止操作
