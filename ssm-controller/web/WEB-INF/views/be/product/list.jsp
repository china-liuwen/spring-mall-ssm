            ...
            <div class="container">
                ...
                <div class="col-md-10 column" id="content">
                    ...
                    <table id="table" class="table table-bordered table-hover">
                        ...
                        <c:forEach items="${pro.list}" var="pr">
                            <tr>
                                <td>${pr.pid}</td>
                                <td>${pr.pname}</td>
                                <td>${pr.subtitle}</td>
                                ...
                                <td>${pr.stock}</td>
                                <td>
                                    <a href='#' class='delete btn btn-danger' onclick="confirmDel(${py.pid})">删除</a>
                    ...
                    <ul class="pagination">
                        <li><a href="/product/list2?pageNum=1"> 首页</a></li>
                        <li><a href="/product/list2?pageNum=${pro.prePage}"> 上一页</a></li>
                        <c:forEach items="${pro.navigatepageNums}" var="p">
                            <li><a href="/product/list2?pageNum=${p}"> ${p}</a></li>
                        </c:forEach>
                        <li><a href="/product/list2?pageNum=${pro.nextPage}"> 下一页</a></li>
                        <li><a href="/product/list2?pageNum=${pro.pages}"> 尾页</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="modal-content" id="content2">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="siteimage" class="col-sm-2 control-label">图片地址</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="siteimage" name="siteimage" />
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    function confirmDel(param){
        ...
        if(window.confirm("您确定要删除吗？")){
            document.location.href="/product/delete?pid="+param
        }
    }
    ...
    function editRole(obj) {
        ...
        //获取表格中的一行数据
        var pid=document.getElementById("table").rows[id].cells[0].innerText;
        var pname = document.getElementById("table").rows[id].cells[1].innerText;
        var subtitle = document.getElementById("table").rows[id].cells[2].innerText;
        var image = document.getElementById("table").rows[id].cells[3].innerText;
        var siteimage = document.getElementById("table").rows[id].cells[4].innerText;
        var datail = document.getElementById("table").rows[id].cells[5].innerText;
        var price = document.getElementById("table").rows[id].cells[6].innerText;
        var stock = document.getElementById("table").rows[id].cells[7].innerText;
        //向模态框中传值
        $('#pid').val(pid);
