...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">后台管理页面</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
                        ...
                        <tbody>
                            <c:forEach items="${page.list}" var="emp">
                                <tr>
                                    ...
                                    <td>${emp.epost}</td>
                                    <td>
                                        <a href='/catering/update?eid=${emp.eid}' class='edit btn btn-info'>编辑</a>
                                        <a href='/catering/delete?eid=${emp.eid}' class='edit btn btn-info'>删除</a>
                                        <a href='/catering/insert?eid=${emp.eid}' class='edit btn btn-info'>新增</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
